...
<main class="container">
   ...
   <?php foreach ($users as $user) : ?>
        ...
        <a class =" btn btn-danger" href="../scripts/deleteUser.php?id=<?php echo $user['id'] ?>" >Zmazat</a>
        <a class ="btn btn-success" href="../pages/profile.php<?php echo "?user=".$user["id"]; ?>" >Profile</a>
   </div>
        </li>
